...
<div class="content-wrapper">
                ...
                <form:form action="${action}" method="POST" modelAttribute="discount">  
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <form:input type="text" class="form-control" path="content" placeholder="Nhập chương trình khuyến mãi"/>
                            <form:errors path="content" cssClass="text-danger" element="div"/>
                        </div>
                        
                        <div class="form-group">
                            <label for="name">Số tiền giảm</label>
                            <form:input type="number" class="form-control" path="moneyReduce" placeholder="Nhập số tiền giảm"/>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <input type="submit" class="btn btn-primary" value="Thêm"  id="randomcode" />
                    </div>
                </form:form> 
            </div>
        </div>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="padding: 5px" class="col-sm-2">
                                            <button type="button"
                                                    ...
                                                    data-toggle="modal"
                                                    onclick="getDiscount(${d.id})">Update</button>
                                        </td>
                                        </td>
                                    </tr>
                                </c:forEach>
    ...
    <div class="modal fade" id="modal-lg-update">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Mã khuyến mãi</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" >  
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name">Chương trình khuyến mãi</label>
                            <input type="text" name="content" class="form-control"  id="contentUpdate" path="content" placeholder=" Nhập chương trình khuyến mãi"/>
                        </div>
                        
                        <div class="form-group">
                            <label for="name">Số tiền giảm</label>
                            <input type="number" name="moneyReduce" class="form-control" path="moneyReduce" id="moneyReduceUpdate" placeholder="Nhập số tiền giảm"/>
                        </div>
