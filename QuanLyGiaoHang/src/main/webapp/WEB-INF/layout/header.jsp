        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 additional-shop-info">
                <ul class="list-unstyled list-inline">
                    <li><i class="fa fa-phone"></i><span>+84 269659325</span></li>
                    <!-- BEGIN CURRENCIES -->
      ...
      <div class="container">
        ...
        <div class="header-navigation">
            <ul>
                ...
                <c:if test="${currentUser.type == 1 || currentUser.type == 0}">
                    <li class="dropdown"><a data-target="#" href="<c:url value="/order"/>">Hóa đơn</a></li>
                </c:if>
                <c:if test="${currentUser.type == 2 && currentUser.status == 1 || currentUser.type == 0}">
                    ...
                    <div class="search-box">
                        <form action="#">
                            <div class="input-group">
                                <input type="text" placeholder="Search" name="kw" class="form-control">
